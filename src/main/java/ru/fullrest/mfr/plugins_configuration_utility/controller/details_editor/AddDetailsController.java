...
public class AddDetailsController implements AbstractController {
    ...
    private class InnerHBox extends HBox {
        ...
        InnerHBox(File file) {
            this.file = file;
            gamePath = new TextField(fileManager.getRelativePath(file, gamePrefix.getText(), optionalPrefix.getText(), false));
            gamePath.setMinWidth(300);
            optionalPath = new TextField(fileManager.getRelativePath(file, gamePrefix.getText(), optionalPrefix.getText(), true));
