package ru.fullrest.mfr.test_server.telegram;
...
import ru.fullrest.mfr.test_server.telegram.command.SetUserRoleCallbackCommand;
...
public class TelegramBot extends TelegramWebhookBot {
    ...
    private final SetUserRoleCallbackCommand setUserRoleCallbackCommand;
    ...
    public BotApiMethod<?> onWebhookUpdateReceived(Update update) {
        ...
        if (update.hasCallbackQuery()) {
            try {
                ...
                setUserRoleCallbackCommand.execute(
